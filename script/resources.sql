...
CREATE TABLE `resources`  (
  ...
  `is_dynamic_routing` tinyint UNSIGNED NULL DEFAULT NULL,
  `dynamic_url` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
